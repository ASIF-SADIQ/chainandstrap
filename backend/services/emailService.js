...
const sendEmail = async ({ to, subject, html }) => {
    ...
    const fromAddress = process.env.RESEND_FROM || 'Chain & Straps <orders@chainandstrap.store>';
        ...
        <tr>
          <td style="background:#0d0d0d;padding:32px 48px;border-top:1px solid #1e1e1e;text-align:center;">
            ...
            <p style="margin:0 0 16px 0;">
              ...
              <a href="https://chainandstrap.store" style="color:#c9a96e;text-decoration:none;font-size:11px;letter-spacing:0.15em;margin:0 12px;">SHOP NOW</a>
              <span style="color:#333;">|</span>
              <a href="https://chainandstrap.store/all" style="color:#c9a96e;text-decoration:none;font-size:11px;letter-spacing:0.15em;margin:0 12px;">COLLECTIONS</a>
            </p>
            ...
            <p style="margin:6px 0 0 0;font-size:10px;color:#2e2e2e;">You received this email because you created an account at chainandstrap.store</p>
          </td>
        </tr>
  ...
  <table cellpadding="0" cellspacing="0" style="margin:0 auto 32px auto;">
    <tr>
      <td style="background:#c9a96e;border-radius:2px;padding:0;">
        <a href="https://chainandstrap.store/verify-email" style="display:inline-block;padding:16px 40px;font-size:11px;font-weight:bold;letter-spacing:0.3em;color:#0d0d0d;text-decoration:none;text-transform:uppercase;">Verify My Account</a>
      </td>
    </tr>
  </table>
...
const passwordResetTemplate = (name, otp) => emailWrapper(`
  ...
  <table cellpadding="0" cellspacing="0" style="margin:0 auto 32px auto;">
    <tr>
      <td style="background:#c9a96e;border-radius:2px;">
        <a href="https://chainandstrap.store/reset-password" style="display:inline-block;padding:16px 40px;font-size:11px;font-weight:bold;letter-spacing:0.3em;color:#0d0d0d;text-decoration:none;text-transform:uppercase;">Reset My Password</a>
      </td>
    </tr>
  </table>
    ...
    <tr>
      <td style="padding:16px 20px;">
        ...
        <p style="margin:0;font-size:12px;color:#883333;line-height:1.6;">
          ...
          <a href="https://chainandstrap.store/login" style="color:#c9a96e;">Secure your account immediately.</a>
        </p>
      </td>
    </tr>
  </table>
  ...
  <p style="margin:0;font-size:11px;color:#3d3d3d;text-align:center;">
    ...
    Chain &amp; Straps Support — support@chainandstrap.store
  </p>
`);
...
const welcomeTemplate = (name) => emailWrapper(`
  ...
  <table cellpadding="0" cellspacing="0" style="margin:0 auto 40px auto;">
    <tr>
      <td style="background:#c9a96e;border-radius:2px;margin-right:12px;">
        <a href="https://chainandstrap.store/all" style="display:inline-block;padding:16px 40px;font-size:11px;font-weight:bold;letter-spacing:0.3em;color:#0d0d0d;text-decoration:none;text-transform:uppercase;">Explore Collections</a>
      </td>
    </tr>
  </table>
  ...
  <p style="margin:0;font-size:12px;color:#555555;text-align:center;line-height:1.6;">
    Questions? We're here for you at <a href="mailto:support@chainandstrap.store" style="color:#c9a96e;text-decoration:none;">support@chainandstrap.store</a>
  </p>
`);
...
const orderReceiptTemplate = (name, orderId, items, total, address) => {
  ...
  return emailWrapper(`
    ...
    <p style="margin:0;font-size:12px;color:#555555;text-align:center;line-height:1.6;">
      ...
      If you have any questions, reply to this email or contact <a href="mailto:support@chainandstrap.store" style="color:#c9a96e;text-decoration:none;">support@chainandstrap.store</a>
    </p>
  `);
};
...
const adminOrderNotificationTemplate = (orderId, customerName, customerEmail, items, total, address) => {
  ...
  return emailWrapper(`
    ...
    <table cellpadding="0" cellspacing="0" style="margin:0 auto;">
      <tr>
        <td style="background:#c9a96e;border-radius:2px;">
          <a href="https://chainandstrap.store/admin" style="display:inline-block;padding:14px 36px;font-size:11px;font-weight:bold;letter-spacing:0.3em;color:#0d0d0d;text-decoration:none;text-transform:uppercase;">View in Admin Panel</a>
        </td>
      </tr>
    </table>
  `);
...
const orderStatusUpdateTemplate = (name, orderId, status) => {
  ...
  return emailWrapper(`
    ...
    <table cellpadding="0" cellspacing="0" style="margin:0 auto 24px auto;">
      <tr>
        <td style="background:#c9a96e;border-radius:2px;">
          <a href="https://chainandstrap.store/account" style="display:inline-block;padding:16px 40px;font-size:11px;font-weight:bold;letter-spacing:0.3em;color:#0d0d0d;text-decoration:none;text-transform:uppercase;">View My Orders</a>
        </td>
      </tr>
    </table>

    <p style="margin:0;font-size:12px;color:#555555;text-align:center;">
      Questions? Contact us at <a href="mailto:support@chainandstrap.store" style="color:#c9a96e;text-decoration:none;">support@chainandstrap.store</a>
    </p>
  `);
};
