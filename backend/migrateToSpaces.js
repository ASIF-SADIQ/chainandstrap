...
async function migrateImages() {
    ...
    // Sort by _id in descending order to process the newest uploads/imports first!
    const products = await Product.find({ 'Image Src': { $not: /digitaloceanspaces\.com/ } }).sort({ _id: -1 });
